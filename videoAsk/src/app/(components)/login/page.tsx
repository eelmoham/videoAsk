          ...
          <div className=" w-full h-full flex flex-col  md:max-w-[20rem] max-w-[19rem] md:min-w-[20rem] min-w-[19rem] p-1 justify-center items-center gap-3">
            ...
            <div className=" flex flex-col w-full gap-2">
              ...
              <button
                ...
                className={` ${(!password || !email)&&' cursor-not-allowed' }   cursor-pointer w-full px-2 py-3 flex justify-center items-center text-white text-lg font-medium bg-[#7d00fe] rounded-xl my-3  gap-3  relative overflow-hidden border border-indigo-600 ${(password && email)&& ' shadow-5xl transition-all duration-200 before:absolute before:bottom-0 before:left-0 before:right-0 before:top-0 before:m-auto before:h-0 before:w-0 before:rounded-sm before:bg-[#825aa3e5] before:duration-300 before:ease-out hover:text-white hover:shadow-indigo-600 hover:before:h-full hover:before:w-full hover:before:opacity-80 max-sm:before:hidden' } `}>
