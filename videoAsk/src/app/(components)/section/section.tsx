    ...
    return (
        <section className=" w-full md:flex justify-between gap-1 animate-fade-up animate-ease-linear md:container">
            <div className=" flex flex-col justify-center gap-3 md:w-1/2 w-[90%] mx-auto">
                ...
                <div className=" bg-black text-white text-2xl md:text:xl rounded-full flex gap-1 justify-center items-center px-3 md:px-6 py-4 md:py-5 md:text-xl md:w-max w-full  mx-auto md:mx-7 my-2 animate-fade-down animate-once animate-delay-500 animate-ease-linear cursor-pointer hover:bg-opacity-45">
