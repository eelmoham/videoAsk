...
const Section = () => {
    return (
        <section className=" w-full md:flex justify-between gap-1 animate-fade-up animate-ease-linear container">
            <div className=" flex flex-col justify-center gap-3    ">
                ...
                <div className=" bg-black text-white rounded-full flex gap-1 justify-center items-center px-3 md:px-6 py-3 md:py-5 md:text-xl w-max  mx-auto md:mx-7 my-2 ">
